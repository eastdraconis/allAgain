...
-  ## 문제인식
    ...
    <img src="./src/assets/images/readmeimages/nervousPiChart.png">

        사람들은 현재 환경문제에 대한 불안감이 높은 편으로 나타납니다

    <img src="./src/assets/images/readmeimages/activeBarChart.png">

        하지만 그에비해 환경을 위한 노력은 하지않는다는 것을 알 수 있습니다.
