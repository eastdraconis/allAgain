...
function ConfirmModal({ showModal, setShowModal }: ConfirmModalProps) {
  const navigator = useNavigate();

  return (
    <ModalBack onClick={() => setShowModal(false)} isActive={showModal}>
      <ModalContainer>
        ...
        <ButtonContainer>
          <ConfirmButton onClick={() => navigator(ROUTE.LOGIN.link)}>
            로그인
          </ConfirmButton>
